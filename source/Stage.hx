...
<<<<<<< HEAD
						...
						var bg:FlxSprite = new FlxSprite(-350,-200).loadGraphic(Paths.datePicture('room','Cloister'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						bg.setGraphicSize(Std.int(bg.width * 0.7));
						...
						var cereal:FlxSprite = new FlxSprite(bg.width /4, bg.height/4 + 10).loadGraphic(Paths.datePicture('c_h_e_e_r_io_s','cameos'));
						cereal.antialiasing = true;
						cereal.scrollFactor.set(0.9, 0.9);
						cereal.active = false;
						cereal.setGraphicSize(Std.int(cereal.width * 0.3));
						...
						var cereal_2:FlxSprite = new FlxSprite(cereal.x + 125, cereal.y).loadGraphic(Paths.datePicture('eat this to be starvn_t','cameos'));
						cereal_2.antialiasing = true;
						cereal_2.scrollFactor.set(0.9, 0.9);
						cereal_2.active = false;
						cereal_2.setGraphicSize(Std.int(cereal_2.width * 0.4));
						...
						var cookie:FlxSprite = new FlxSprite(cereal.x + 250, cereal.y + 20).loadGraphic(Paths.datePicture('cookies','Cloister'));
						if (Std.random(2) == 1) {
							cookie = new FlxSprite(cereal.x + 250, cereal.y + 20).loadGraphic(Paths.datePicture('pogchair','cameos'));
							cookie.setGraphicSize(Std.int(cookie.width * 0.075));
						} else {
							cookie.setGraphicSize(Std.int(cookie.width * 0.75));
						}
						...
						var flowers:FlxSprite = new FlxSprite(bg.width /2-400, bg.height/2-220).loadGraphic(Paths.datePicture('flowers','Cloister'));
						flowers.antialiasing = true;
						flowers.scrollFactor.set(1, 1);
						flowers.active = false;
						flowers.setGraphicSize(Std.int(flowers.width * 0.6));

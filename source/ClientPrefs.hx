...
class ClientPrefs {
	public static var cutsceneLanguage = 'English';
	...
	public static function saveSettings() {
		FlxG.save.data.cutsceneLanguage = cutsceneLanguage;
		...
		save.bind('controls_v2', 'Corrun'); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
	...
	public static function loadPrefs() {
		if(FlxG.save.data.cutsceneLanguage != null) {
			cutsceneLanguage = FlxG.save.data.cutsceneLanguage;
		}

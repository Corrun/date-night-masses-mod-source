...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["No Tables allowed",			"Beat the Vibe Check Week.",											'no_tables_allowed',		false,	'kikyotable'],
		["Hi Chat",						"Get the easter egg on the pause menu.",								'hi_chat',			 		false,	'hi_chat'],
		...
		["Ultimate Domination",			"Beat Vibe-Check with 50 misses or more.",								'ultimate_domination',		false,	'dominance'],
